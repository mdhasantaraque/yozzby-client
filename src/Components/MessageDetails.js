...
const MessageDetails = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-1 gap-4 my-8 mx-4 md:mx-auto md:w-3/5">
      <div className="block gap-3 mx-auto group  dark:bg-gray-300">
        <img
          src={image}
          alt=""
        ...
        <div className="p-6 space-y-2 lg:col-span-5">
          <h3 className="text-2xl font-semibold text-gray-700 sm:text-4xl">
            {name}
          </h3>
            ...
            <div className="space-x-2">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 512 512"
                  className="w-4 h-4 fill-current dark:text-gray-600"
                >
